...
export default function Header() {
    ...
    return (
        ...
        <header className="w-full bg-white z-50 pt-12 pb-8 md:pb-12">
            ...
            <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-center flex-wrap">

                {/* Logo Area */}
                <Link href="/" className="flex items-center text-xl sm:text-2xl font-fira font-normal text-[#333] transition-colors hover:text-[#b0b0b0] whitespace-nowrap mb-4 md:mb-0 mr-0 md:mr-8 lg:mr-12">
                ...
                {/* Navigation Links */}
                <nav className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 md:gap-8 font-sans">
