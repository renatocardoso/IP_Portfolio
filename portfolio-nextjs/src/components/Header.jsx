...
export default function Header() {
    ...
    return (
        ...
        <header className="w-full bg-white z-50 pt-12 pb-8 md:pb-12">
            ...
            <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center justify-center lg:gap-8">

                {/* Logo Area */}
                <Link href="/" className="flex items-center text-2xl font-fira font-normal text-[#333] transition-colors hover:text-[#b0b0b0] whitespace-nowrap mb-6 lg:mb-0">
                ...
                {/* Navigation Links */}
                <nav className="flex flex-col lg:flex-row items-center justify-center gap-4 lg:gap-8 font-sans">
